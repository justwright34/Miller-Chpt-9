...
pdf(file="fig_market_basket_initial_item_support.pdf", 
    width = 8.5, height = 11)
itemFrequencyPlot(Groceries, support = 0.025, cex.names=0.8, xlim = c(0,0.3),#support command is a frequency measure, 
                  #here it is for items that are purchased greater than 2.5% of the time
